  ...
  fetch(`${endpoint}/teams.json`, {
    ...
    .then((data) => {
      if (data) {
        ...
        const filteredTeams = allTeams.filter((team) => team.uid === uid || team.public);
...
export {
  getTeams, getSingleTeam, createTeam, updateTeam, getTeamMembers, deleteTeam, getAllPublicTeams,
};
